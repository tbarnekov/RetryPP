...
RetryPP::Policy policy = RetryPP::Policy::null();
RetryPP::Classifier<HttpResponseCode> classifier = RetryPP::Classifier<HttpResponseCode>::null();
...
int main()
{
	...
	{
		{
			classifier = ClassifierBuilder<HttpResponseCode>()
		...
		withRetry(policy, classifier, &operation1);
